<template>
	<div id="comment" name="comment">
		<div id="comment" class="home-brick-box home-brick-row-2-box xm-plain-box J_itemBox J_brickBox is-visible loaded">
            <div class="box-hd">
                <h2 class="title">热评产品</h2>
            </div>
            <div class="more">
            	<el-row type="flex" justify="space-around">
				    <el-col :span="6"><brick class="brick-item-m"/></el-col>
				    <el-col :span="6"><brick class="brick-item-m"/></el-col>
				    <el-col :span="6"><brick class="brick-item-m"/></el-col>
				    <el-col :span="6"><brick class="brick-item-m"/></el-col>
			    </el-row>
