	...
	<div id="smart" name="smart">
		<div id="smart" class="home-brick-box home-brick-row-2-box xm-plain-box J_itemBox J_brickBox is-visible loaded">
            <div class="box-hd">
                ...
                <div class="more">
                	<el-menu :default-active="activeIndex" class="tab-list" mode="horizontal" @select="handleSelect">
					  <el-menu-item index="1">热门</el-menu-item>
					  <el-menu-item index="2">出行</el-menu-item>
					  <el-menu-item index="3">健康</el-menu-item>
					  <el-menu-item index="4">酷玩</el-menu-item>
					  <el-menu-item index="5">路由器</el-menu-item>
					</el-menu>
                </div>
            </div>
            <div class="row clearfix">
            	<div class="brick-promo-list">
            		<simg class="brick-item-m"  v-for="item in subList" v-bind:todo="item" />
            	</div>
...
export default {
  ...
  data () {
    return {
        activeIndex:'1',
        subList: [
          { src: 'http://i3.mifile.cn/a4/xmad_1496673909036_BxUMZ.jpg' },
          { src: 'http://i3.mifile.cn/a4/xmad_14950996440442_FrUIx.jpg' }
        ],
        brickList:[
              { 
              ...
              { 
                href: 'http://item.mi.com/product/5348.html',
                src: 'http://i3.mifile.cn/a4/xmad_14926528960147_wJMsC.png',
                title: '小米',
                desc: '小米加大米',
                price: '555',
                author: 'JohnSon',
